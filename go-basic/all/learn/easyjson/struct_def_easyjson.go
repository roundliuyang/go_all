...
func easyjson7c82d03DecodeAllAllLearnEasyjson(in *jlexer.Lexer, out *JobInfo) {
...
func easyjson7c82d03EncodeAllAllLearnEasyjson(out *jwriter.Writer, in JobInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v JobInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c82d03EncodeAllAllLearnEasyjson(&w, v)
...
func (v *JobInfo) UnmarshalJSON(data []byte) error {
	...
	easyjson7c82d03DecodeAllAllLearnEasyjson(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *JobInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeAllAllLearnEasyjson(l, v)
}
func easyjson7c82d03DecodeAllAllLearnEasyjson1(in *jlexer.Lexer, out *Employee) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7c82d03EncodeAllAllLearnEasyjson1(out *jwriter.Writer, in Employee) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Employee) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c82d03EncodeAllAllLearnEasyjson1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Employee) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7c82d03DecodeAllAllLearnEasyjson1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Employee) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeAllAllLearnEasyjson1(l, v)
}
func easyjson7c82d03DecodeAllAllLearnEasyjson2(in *jlexer.Lexer, out *BasicInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7c82d03EncodeAllAllLearnEasyjson2(out *jwriter.Writer, in BasicInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v BasicInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c82d03EncodeAllAllLearnEasyjson2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *BasicInfo) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7c82d03DecodeAllAllLearnEasyjson2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *BasicInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeAllAllLearnEasyjson2(l, v)
}
